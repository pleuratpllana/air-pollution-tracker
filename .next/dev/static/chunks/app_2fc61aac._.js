...
function AQICard({ city }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AQICard.useEffect": ()=>{
            const fetchData = {
                "AQICard.useEffect.fetchData": async ()=>{
                    setError(false);
                    setData(null); // show loading while fetching
                    const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$fetchAirQuality$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchAirQuality"])(city);
                    if (!result) setError(true);
                    else setData(result);
                }
            }["AQICard.useEffect.fetchData"];
            fetchData();
            const interval = setInterval(fetchData, 5 * 60 * 1000); // refresh every 5 min
            return ({
                "AQICard.useEffect": ()=>clearInterval(interval)
            })["AQICard.useEffect"];
        }
    }["AQICard.useEffect"], [
        city
...
_s(AQICard, "N0th3ZFDN+Kp8tlE0nhcPaJ3vjE=");
_c = AQICard;
var _c;
...
//# sourceMappingURL=app_2fc61aac._.js.map