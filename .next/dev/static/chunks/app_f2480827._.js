...
async function fetchAirQuality(city) {
    const token = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.WAQI_API_TOKEN;
    ...
    try {
        const res = await fetch(`https://api.waqi.info/feed/${encodedCity}/?token=${token}`);
...
function Home() {
    ...
    const noCityFound = search && filteredCities.length === 0;
    // Apply tab filter
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            "least"
                                ...
                                className: `px-3 py-1 rounded-full text-sm font-medium ${filterTab === tab ? "bg-white text-black" : "bg-black/30 text-white hover:bg-black/50"} transition`,
                                children: tab === "all" ? "All" : tab === "most" ? "Most Polluted" : "Least Polluted"
                            }, tab, false, {
                                fileName: "[project]/app/page.tsx",
                                lineNumber: 93,
                                columnNumber: 13
...
//# sourceMappingURL=app_f2480827._.js.map